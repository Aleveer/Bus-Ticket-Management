...
--
INSERT INTO
  `route` (`route_id`, `name`, `time`, `distance`)
VALUES
  (
    'BLHCM',
...
ADD
  UNIQUE KEY `checkpoint_id` (`checkpoint_id`);
...
ALTER TABLE
  `spring_session`
ADD
  PRIMARY KEY (`PRIMARY_ID`, `SESSION_ID`);
...
ALTER TABLE
  `account`
ADD
  CONSTRAINT `account_ibfk_1` FOREIGN KEY (`role_id`) REFERENCES `role` (`role_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE
  `role_permission`
ADD
  CONSTRAINT `role_permission_ibfk_1` FOREIGN KEY (`role_id`) REFERENCES `role` (`role_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD
...
ALTER TABLE
  `trip`
ADD
  CONSTRAINT `trip_ibfk_1` FOREIGN KEY (`route_id`) REFERENCES `route` (`route_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD
  CONSTRAINT `trip_ibfk_2` FOREIGN KEY (`bus_id`) REFERENCES `bus` (`bus_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD
