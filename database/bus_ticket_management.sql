...
VALUES
  (
    ...
    '$2a$10$0ynbWmgn8OwsPKfZlsj5cO/SdyAJmJ2p/VnSnseA0oDNWOI0gb272',
    'Nguyen Van A',
    '01234567890',
    1,
    'verified',
    NULL,
    NULL,
    'eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ0aGVwcm9nYW1pbmdvZmRlYXRoMTIzQGdtYWlsLmNvbSIsImlhdCI6MTcyNzI3Mjk0NywiZXhwIjoxNzI3Mjc2NTQ3fQ.KrxRDIYCDtKgGov86G_f5Ynby-hVrupPmDnWGB1Qcs0',
    NULL,
    NULL,
    1
  );
...
ADD
  PRIMARY KEY (`id`),
ADD
  UNIQUE KEY `route_id` (`route_id`, `stop_order`),
ADD
...
ALTER TABLE
  `checkpoints`
ADD
  CONSTRAINT `checkpoints_ibfk_1` FOREIGN KEY (`route_id`) REFERENCES `routes` (`id`),
ADD
  CONSTRAINT `checkpoints_ibfk_2` FOREIGN KEY (`location_id`) REFERENCES `locations` (`id`);
...
ALTER TABLE
  `routes`
ADD
  CONSTRAINT `routes_ibfk_1` FOREIGN KEY (`start_location_id`) REFERENCES `locations` (`id`),
ADD
  CONSTRAINT `routes_ibfk_2` FOREIGN KEY (`end_location_id`) REFERENCES `locations` (`id`);
...
ALTER TABLE
  `schedule_checkpoints`
ADD
  CONSTRAINT `schedule_checkpoints_ibfk_1` FOREIGN KEY (`schedule_id`) REFERENCES `schedules` (`id`),
ADD
  CONSTRAINT `schedule_checkpoints_ibfk_2` FOREIGN KEY (`checkpoint_id`) REFERENCES `checkpoints` (`id`);
...
ALTER TABLE
  `seat_reservations`
ADD
  CONSTRAINT `seat_reservations_ibfk_1` FOREIGN KEY (`seat_id`) REFERENCES `seats` (`id`),
ADD
  CONSTRAINT `seat_reservations_ibfk_2` FOREIGN KEY (`schedule_id`) REFERENCES `schedules` (`id`);
...
ADD
  CONSTRAINT `transaction_history_ibfk_2` FOREIGN KEY (`order_id`) REFERENCES `payment` (`id`),
ADD
  CONSTRAINT `transaction_history_ibfk_3` FOREIGN KEY (`booking_id`) REFERENCES `bookings` (`id`);
