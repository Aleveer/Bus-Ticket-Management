...
CREATE TABLE `booking` (
  ...
  `drop_off_point` varchar(100) NOT NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci;
...
ALTER TABLE
  `seat_availability`
ADD
  CONSTRAINT `seat_availability_ibfk_2` FOREIGN KEY (`trip_id`) REFERENCES `trip` (`trip_id`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD
  CONSTRAINT `seat_availability_ibfk_3` FOREIGN KEY (`seat_id`) REFERENCES `bus_seats` (`id`);
